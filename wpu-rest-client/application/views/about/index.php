    ...
    <div class="row">
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5>JSON</h5>
            <p class="card-text">Latihan pemanfaatan data JSON untuk API sederhana.</p>
      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5>WPU-HUT</h5>
            <p class="card-text">Eksperimen API dengan JSON dalam sebuah website sederhana.</p>
      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5>WPU-MOVIE</h5>
            <p class="card-text">Implementasi API publik OMDb untuk aplikasi pencarian film berbasis web.</p>
    ...
    <div class="row">
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h5>WPU-PORTFOLIO</h5>
            <p class="card-text">Membangun website portfolio menggunakan API YouTube dan Instagram melalui cURL.</p>
      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Pembuatan REST API server menggunakan framework CodeIgniter 3.</p>
      ...
      <div class="col-md mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Pembuatan REST API client dengan framework CodeIgniter 3.</p>
