    ...
    <div class="jumbotron" id="home">
      <div class="container">
        <div class="text-center">
          <img src="<?= base_url(); ?>assets/img/profile5.png" class="rounded-circle img-thumbnail">
          <h1 class="display-4">Suci Khalisyafitri</h1>
          <h3 class="lead">2217020048 | 6-SI.C | Projek IAP (API)</h3>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4">
            ...
            <ul class="list-group mb-4">
              ...
              <li class="list-group-item">Sungai Bangek, Balai gadang</li>
